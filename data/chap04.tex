...
\begin{figure}
    \centering
    \subcaptionbox{第一代无人机}
      {\includegraphics[width=0.47\linewidth]{1st_gen.jpg}}
    \subcaptionbox{第二代无人机}
      {\includegraphics[width=0.47\linewidth]{2nd_gen.jpg}}
      \subcaptionbox{第三代无人机}
      {\includegraphics[width=0.47\linewidth]{3rd_gen.jpg}}
    \caption{室内场景实机任务测试}
    \label{fig_3gen}
\end{figure}
% \begin{figure}
%     \centering
%     \includegraphics[width = 0.8\textwidth]{1st_gen.jpg}
%     \caption{第一代无人机}
%     \label{fig_1st_gen}
% \end{figure}
% \begin{figure}
%     \centering
%     \includegraphics[width = 0.8\textwidth]{2nd_gen.jpg}
%     \caption{第二代无人机}
%     \label{fig_2nd_gen}
% \end{figure}
% \begin{figure}
%     \centering
%     \includegraphics[width = 0.8\textwidth]{3rd_gen.jpg}
%     \caption{第三代无人机}
%     \label{fig_3rd_gen}
% \end{figure}
\begin{table}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.8\textwidth]{dynamics.png}
    \caption{无人机动力学模型}
    \label{fig_dyn}
\end{figure}
